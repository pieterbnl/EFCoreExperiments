...
public class Seeding
{
    public static void Seed(ModelBuilder modelBuilder)
    {
        ...
        // 4326 == partial data operations on planet earth
        ...
        // working with relationships between movies, cinema's, cinemahalls and actors
        // names of join tables
        var entityCinemaHallMovie = "CinemaHallMovie";
        var cinemaHallsId = "CinemaHallsId"; // FK
        var moviesId = "MoviesId"; // FK

        var entityGenreMovie = "GenreMovie";
        var genresId = "GenresId";

        // inserting records in join table
